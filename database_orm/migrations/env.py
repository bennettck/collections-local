...
from database_orm.models import Base
from database_orm.connection import _get_database_url
...
def run_migrations_online() -> None:
    ...
    """
    # Override the sqlalchemy.url from ini file with our dynamic URL
