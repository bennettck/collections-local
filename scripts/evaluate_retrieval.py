...
class MultiSearchRetrievalEvaluator:
    ...
    VALID_SEARCH_TYPES = ["bm25-lc", "vector-lc", "hybrid-lc", "agentic"]
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="all",
        help="Comma-separated search types to evaluate: 'bm25-lc', 'vector-lc', 'hybrid-lc', 'agentic', or 'all' (default: all)"
    )
    parser.add_argument(
        "--parallel",
        action="store_true",
