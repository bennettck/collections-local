...
class PGVectorStoreManager:
    ...
    def add_document(
        ...
        Convenience method for adding a single document with proper metadata.
        This is the primary method used by the embedder Lambda.
        ...
        # Add user_id for multi-tenancy if provided
        if user_id:
